...
import '../controllers/recognize_controller.dart';
...
class RecognizePage extends GetView<RecognizeController> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(
                      ...
                      placeholder: '例如：Line Of Duty S01 2012 1080i... ',
                    ),
                    ...
                    _buildTextField(
                      ...
                      placeholder: '例如：重任在肩 第一季 / 反腐先锋 第一季',
                      minLines: 2,
                      maxLines: 4,
                    ),
              ...
              Obx(() {
                final media = controller.recognizeResponse.value?.media_info;
                if (media != null) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Section(
                      child: Obx(() {
                        final status = controller.statusCode.value;
                        final error = controller.errorText.value;
                        final result = controller.resultText.value;
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Section(
                      ...
                      child: _buildMediaDetail(context, media),
                    ),
                  ],
                );
              }),
  ...
  Widget _buildMediaDetail(BuildContext context, MediaInfo media) {
      ...
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            return CachedImage(imageUrl: items[index], fit: BoxFit.cover);
          },
        );
      },
    );
  ...
  Widget _buildHeroText(
    ...
    final labelColor = CupertinoColors.white.withOpacity(0.9);
      ...
      children: [
        ...
        if (subtitle != null) ...[
          ...
          Text(
            ...
            maxLines: 2,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(fontSize: 12, color: labelColor, shadows: shadow),
          ),
        ],
  ...
  String _buildTitle(MediaInfo media) {
  ...
  String? _buildSubtitle(MediaInfo media) {
  ...
  String? _buildSeasonSummary(MediaInfo media) {
  ...
  String? _buildActors(List<Actor>? actors) {
  ...
  List<String> _buildGenres(List<Genre>? genres) {
  ...
  List<String> _buildAltNames(List<String>? names) {
  ...
  String? _resolveImageUrl(MediaInfo media, String? path) {
  ...
  String? _buildTmdbUrl(MediaInfo media) {
  ...
  String _tmdbTypeFromMedia(MediaInfo media) {
  ...
  List<String> _collectPosterUrls(MediaInfo media) {
    final urls = <String>[];
